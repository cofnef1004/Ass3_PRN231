...
namespace FlowerBouquetWebClient.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<ApplicationUsers> signInManager, ILogger<LoginModel> logger, IConfiguration configuration, UserManager<ApplicationUsers> userManager)
        {
            ...
            AuthenUrl = "http://localhost:5135/api/User";
